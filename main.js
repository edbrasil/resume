...
var apiUrl = "https://raw.githubusercontent.com/edbrasil/resume/master/resume.json"
...
d3.json(apiUrl, function(error, data) {
	console.log(data);
	var educationNestData = educationNest.map(data.work, d3.map).values();
	var workNestData = workNest.map(data.education, d3.map).values();
